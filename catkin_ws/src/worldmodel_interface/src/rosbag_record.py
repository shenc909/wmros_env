...
# Credits to Marco: https://github.com/marco-tranzatto for the ROSBag start and stop automation
...
class RosbagRecord:
    def __init__(self, script, record_folder):
        ...
        # Start recording.
        command = script
        self.p = subprocess.Popen(command, stdin=subprocess.PIPE, shell=True, cwd=record_folder,
                                    executable='/bin/bash')
